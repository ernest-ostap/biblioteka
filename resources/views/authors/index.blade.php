<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- szukajka -->
            <form method="GET" action="{{ route('authors.index') }}" class="mb-6 flex items-center gap-2">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Szukaj po imieniu lub nazwisku..." class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="{{ route('authors.edit', $author) }}" 
                                               class="text-white hover:text-yellow-900 mx-2 dark:text-yellow-400 dark:hover:text-yellow-300 transition duration-150">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <form action="{{ route('authors.destroy', $author) }}" method="POST" class="inline">
                                                ...
                                                @method('DELETE')
                                                <button type="submit" 
                                                        class="text-red-600 hover:text-red-900 mx-2 dark:text-red-400 dark:hover:text-red-300 transition duration-150"
