                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('categories.show', $category) }}" 
                                               class="text-white hover:text-blue-900 dark:text-white dark:hover:text-blue-300 transition duration-150">
                                            ...
                                            <a href="{{ route('categories.edit', $category) }}" 
                                               class="text-white hover:text-yellow-900 dark:text-white dark:hover:text-yellow-300 transition duration-150">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
